...
<ul><a href="index.php">Все товары</a>
    <li> 
        <ul ><a href="index2.php">Телевизоры</a>
            ...
            <li>
            <ul class="u-list"><a href="#" class="list-toggle">Плазменные Телевизоры</a>
                <li><a href="index10.php">Диагональю до 50 дюймов</a></li>
                <li><a href="index11.php">Диагональю более 50 дюймов</a></li>
            </ul>
            </li>
        </ul>
    </li>
...
$sql = "SELECT * FROM products WHERE id_group=4 or id_group=7 or id_group=8";
